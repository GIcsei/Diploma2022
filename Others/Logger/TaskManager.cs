...
namespace PSI_Checker_2p0.Logger
{
    ...
    public class TaskManager : ITaskManager
    {
        ...
        {
            //DIService.Logger.Log($"An unexpected error occurred running a DIService.Task.Run. {ex.Message}", LogLevel.Debug, origin, filePath, lineNumber);
        }
